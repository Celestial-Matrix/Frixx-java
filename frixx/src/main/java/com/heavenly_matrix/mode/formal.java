        ...
        while (true){
            while (true) {
                ...
                if (command.contains("hi") || command.contains("yo") || command.contains("heya") || command.contains("hello")) {
                    ...
                    System.out.print("The best in the world! KATAKURI! ");
                    ...
                    System.out.print("I\'m Frix, a chatbot created by Airito and Katakuri to help with various tasks and provide info. ");
                    ...
                    System.out.print("I\'m a chatbot, not a human, but I\'m here 2 help! ");
                ...
                } else if (command.contains("what\'s the best way 2 cook ") || command.contains("cook ")) {
