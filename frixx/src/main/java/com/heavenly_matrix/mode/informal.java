...
import com.heavenly_matrix.game.*;
        ...
        while (true){
            while (true) {
                ...
                if (command.contains("hi") || command.contains("yo") || command.contains("heya") || command.contains("hello")) {
                    ...
                    System.out.println("Bidu Me changing to Chindi Bindi Mode");
                } else if (command.contains("tu kaisa")) {
                    System.out.println("Mai Accha hai re baba, tu kaisa;");
                } else if (command.contains("mai accha")) {
                    System.out.println("Sahi hai re baba, kya kar raha hai re tu baba");
                } else if (command.contains("kar")) {
                    System.out.println("Sahi hai tereliye re baba");
